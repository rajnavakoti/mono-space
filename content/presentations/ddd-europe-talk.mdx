...
## Option A — Bounded Context Cards

<BoundedContextCards version="1" />

<Notes>
Visual comparison slide. Same v0.1 state as the previous slide, but rendered as labelled bounded-context cards: heavy borders, status colour, findings as chips inside each card, connection arrows in an SVG overlay with HTML labels.
</Notes>

---

## Option B — Whiteboard sketch

<WhiteboardSketch version="1" />

<Notes>
Visual comparison slide. Same v0.1 state, rendered as off-axis whiteboard boxes on a paper background with amber sticky-note annotations attached to findings, slightly hand-drawn feel.
</Notes>

---

## Option C — Schema-zoomed map

<SchemaZoomedMap version="1" />

<Notes>
Visual comparison slide. Same v0.1 state, rendered as mini code windows per context — each shows the actual schema, the god-entity context (Shipment) shows its borrowed fields inline with the amber note.
</Notes>
