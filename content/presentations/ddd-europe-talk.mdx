...
<Callout type="tip" label="EXHIBIT A SAID">
**Consignee Service**

~~✓ Clean boundary~~

~~Referenced by all. References nobody. Published language.~~
</Callout>

</div>
<div>

<Callout type="danger" label="EXHIBIT B SAYS">
**Consignee's `customer_addresses` table**

✗ Read directly by **3 services**

**Shipment, Carrier, Invoicing** — all bypass the API.

The boundary is clean at the API level. The database says it's a **facade**.
</Callout>

</div>
</Split>

> *"Contracts declared a boundary. The database showed it doesn't exist."*
